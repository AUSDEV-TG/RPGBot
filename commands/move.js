...
module.exports.run = (client, message, args) => {
	// Try to load the character, if an error occurs, the user has no character
	try {
    ...
    if (num === undefined || Number.isNaN(num) === true) {
    	message.reply("Please specify a direction and distance.");
    	return;
    }
	...
	//message.reply(character.name + " has moved " + args[1] + " units " + args[0] + ".");
